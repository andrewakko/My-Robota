...
public class My_Robota_awk extends PApplet {
...
// check open GL easycam pEsayCam
 ...
 public void keyPressed() {
  ...
  if(key == '='){
  zoom = zoom+0.1f;// have to come after set view
  }
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "My_Robota_awk" });
  }
}
